...
-- Schema pizzeria
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `pizzerias` ;

-- -----------------------------------------------------
-- Schema pizzeria
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `pizzerias` DEFAULT CHARACTER SET utf8 ;
USE `pizzerias` ;

-- -----------------------------------------------------
-- Table `pizzeria`.`pizza`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pizzerias`.`pizza` ;

CREATE TABLE IF NOT EXISTS `pizzerias`.`pizza` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pizzerias`.`customer` ;

CREATE TABLE IF NOT EXISTS `pizzerias`.`customer` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pizzerias`.`pizza_order` ;

CREATE TABLE IF NOT EXISTS `pizzerias`.`pizza_order` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pizzerias`.`order_item` ;

CREATE TABLE IF NOT EXISTS `pizzerias`.`order_item` (
...
-- Table `pizzeria`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pizzerias`.`user` ;

CREATE TABLE IF NOT EXISTS `pizzerias`.`user` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pizzerias`.`user_role` ;

CREATE TABLE IF NOT EXISTS `pizzerias`.`user_role` (
  `username` VARCHAR(20) NOT NULL,
